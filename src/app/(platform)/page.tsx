...
export default function Home() {
  return (
    <section className="@container w-screen px-4 lg:px-8 h-svh flex flex-col justify-center items-center bg-gradient-to-tr from-30% from-background to-primary">
